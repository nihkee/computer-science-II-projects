...
public:
  ...
  ~Playlist();
  // Name: SetPlaylistName(string name)
  // Desc - Allows user to name the playlist
  // Precondtion: Requires string input from user
  // Postcondition: M_name is now intialized
  void SetPlaylistName(string name);
  // Name: GetPlaylistName()
  // Desc - Returns m_name
  // Precondtion: none
  // Postcondition: m_name is returned
